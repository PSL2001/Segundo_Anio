...
$provincia = (new Provincias)->read($id);
        ...
        <div class="w-full bg-gray-800 h-screen">
            ...
            <div class="max-w-5xl mx-auto px-6 sm:px-6 lg:px-8 mb-12">
                <div class="bg-gray-900 w-full shadow rounded p-8 sm:p-12 -mt-72">
                    <p class="text-3xl font-bold leading-7 text-center text-white">Editar Provincia</p>
                    <form action="<?php echo $_SERVER['PHP_SELF']."?id=$id" ?>" method="POST">
                        <div class="md:flex items-center mt-12">
                            <div class="w-full md:w-1/2 flex flex-col">
                                <label class="font-semibold leading-none text-gray-300">Nombre</label>
                                <input type="text" value="<?php echo $provincia->nombre ?>" class="leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-4 border-0 bg-gray-800 rounded" name="nombre" />
                                <?php
                        ...
                        <div>
                            <div class="w-full flex flex-col mt-8">
                                ...
                                <textarea type="text" name="descripcion" class="h-40 text-base leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-gray-800 border-0 rounded"><?php echo $provincia->descripcion; ?> &nbsp;</textarea>
                                <?php
