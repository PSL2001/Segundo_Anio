        ...
        <div class="relative min-h-screen flex flex-col sm:justify-self-auto items-center bg-blue-400">
            ...
            <div class="relative sm:max-w-sm w-full">
                <div class="flex-auto justify-self-auto mt-7 mb-7">
                    <a href="cprovincia.php" class="relative w-fit h-fit px-4 py-2 text-xl border rounded-full bg-gray-500 text-white">
            ...
            <table class="min-w-full border-collapse block md:table">
                ...
                <tbody class="block md:table-row-group">
                    ...
                    while ($fila = $provincias->fetch(PDO::FETCH_OBJ)) {
                        ...
                        <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-1/3 md:hidden font-bold">Id</span>{$fila->id}</td>
                        ...
                        <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-1/3 md:hidden font-bold">Descripcion</span>{$fila->descripcion}</td>
                        <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                <span class="inline-block w-1/3 md:hidden font-bold">Actions</span>
                                <form name="a" method='POST' action="bprovincia.php">
                                <input name="id" value="{$fila->id}" type="hidden" />
                                <a href="eprovincia.php?id={$fila->id}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 border border-blue-500 rounded">Editar</a>
                                <button type="submit" onclick="return confirm('¿Borrar provincia?')" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 border border-red-500 rounded">Borrar</button>
                                </form>
                            </td>
                        </tr>
                        TXT;
