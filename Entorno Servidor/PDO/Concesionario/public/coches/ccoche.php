        ...
        <div class="my-2 p-4 mx-auto" style="background-color:#c0ca33; width:40rem">
            ...
            <form name="s" action='<?php echo $_SERVER['PHP_SELF']; ?>' method='POST' enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="n" placeholder="Modelo Coche" name="modelo">
                    <?php
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="p" placeholder="Km" name="kilometros">
                    <?php
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="p" placeholder="Color" name="kilometros">
                    <?php
