<div>
    ...
    <x-jet-dialog-modal wire:model="isOpen">
        ...
        <x-slot name="content">
            ...
            <x-jet-input type="text" placeholder="Titulo" class="mt-2 mb-4 w-full" wire:model.defer="titulo"/>
            <x-jet-input-error for="titulo" />
            <x-jet-label value="Contenido del Post" />
            <textarea wire:model.defer="contenido" class="w-full mt-2 mb-4  border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" placeholder="Contenido del Post"></textarea>
        ...
        <x-slot name="footer">
            <button wire:loading.attr="disabled" wire:click="guardar" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
