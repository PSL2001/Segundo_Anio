...
@endsection
@section('cabecera')
Editando Categoria: {{$category->id}}
@endsection
@section('contenido')
...
<div>
    ...
    <input type="text" value="{{$category->nombre}}" name="nombre" id="nombre" required class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-2 py-2 sm:text-sm border-gray-300 rounded-md" placeholder="Nombre Categoria">
    @error('nombre')
...
<div class="mt-2">
    ...
    <input type="text" value="{{$category->descripcion}}" name="descripcion" id="desc" required class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-2 py-2 sm:text-sm border-gray-300 rounded-md" placeholder="Descripcion Categoria">
    @error('descripcion')
    <p class="text-sm text-red-500 mt-3">{{$message}}</p>
    @enderror
</div>
