                ...
                <form action="{{ route('articles.store') }}" name="as" method="post">
                    ...
                    <div class="md:flex items-center mt-12">
                        <div class="w-full md:w-full flex flex-col">
                            ...
                            <input type="text" name="nombre" required placeholder="Titulo del Articulo"
                    ...
                    <div class="md:flex items-center mt-12">
                        <div class="w-full md:w-full flex flex-col">
                            <label class="font-semibold leading-none text-gray-300">Categoria</label>
                    ...
                    <div>
                        <div class="w-full flex flex-col mt-8">
                            ...
                            <textarea type="text" name="descripcion" required placeholder="Descripcion del Articulo"
                    ...
                    <div class="flex items-center justify-center w-full">
                        ...
                        <a href="{{ route('articles.index') }}"
                            class="mt-9 font-semibold leading-none text-white py-4 px-10 bg-yellow-700 rounded hover:bg-yellow-600 focus:ring-2 focus:ring-offset-2 focus:ring-yellow-700 focus:outline-none"><i
